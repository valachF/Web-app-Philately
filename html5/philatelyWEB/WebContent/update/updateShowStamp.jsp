...
<body>
	...
	<div id="headerLine">
        ...
        <% 
            ...
            //String idS=request.getParameter("idstamp"); 
        //    Integer idstamp= (Integer)session.getAttribute("idstamp"); 
            System.out.println("vrednost idstamp-a u updateShowStamp: "+idstamp);
			boolean exist=false;
			Stamp marka=null;
	      //if(opisMarke!=null){
			if(idstamp!=0){
				...
				System.out.println("vrednost idstamp-a u updateShowStamp u IFu: "+marka.getIdStamp());
				if(marka !=null){
					exist=true;
				}
			}	
		%>
		<form  method="post" action="/philatelyWEB/save/saveStampUp.jsp" enctype="multipart/form-data">
		<table>
		<tr>
		...
		<tr>
			<td><input type="submit" name="saveup" value=Sacuvaj></input></td>
			<td><input type="submit" name="deleteup" value=Brisi!></input></td>
		</tr>
	</table>
	</form>
	</article>
