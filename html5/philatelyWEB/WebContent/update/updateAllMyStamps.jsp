...
<%
       ...
       // 	System.out.println("Korisnik postoji");
		...
		if(exist){
	%>
	<form  method="post" action="/philatelyWEB/update/updateShowStamp.jsp">
		<table>
			<tr>
				<td>Sve marke:</td>
				<td><select name="marka"> 
					<%for(int i=0;i<stampList.size();i++){
					    ...
					    System.out.println("vrednost idStamp-s u updateAllMyStamps: "+idstamp);
					    idstamp=stampList.get(i).getIdStamp();
					    //session.setAttribute("idstamp", idstamp);
					 %>
