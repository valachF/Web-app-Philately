...
<body>
	...
	<article>
		...
		<table>
			<tr>
				<td>ID serije</td>
				<td><input name="id" type="text" value="<%=serija.getIdSeries() %>" ></td>
			</tr>
			<tr>
				<td>Opis serije</td>
				<td><input name="description" type="text" value="<%=serija.getSeriesDescription() %>" ></td>
			</tr>
			<tr>
				<td>Stamparija</td>
				<td><input name="office" type="text" value="<%=serija.getPrintOffice() %>" ></td>
			</tr>
		</table>
				</article>
