...
<body>
	...
	<% 
		...
		<table>
			<tr>
				<td>ID korisnika</td>
				<td><input name="idUser" type="text" value="<%=korisnik.getIdUser() %>" ></td>
			</tr>
			<tr>
				<td>Korisnicko ime</td>
				<td><input name="userName" type="text" value="<%=korisnik.getUserName() %>" ></td>
			</tr>
			<tr>
				<td>Sifra</td>
			...
			<tr>
				<td>Role</td>
				<td><input name="role" type="text" value="<%=korisnik.getRole() %>" ></td>
			</tr>			
		</table>
		</article>
